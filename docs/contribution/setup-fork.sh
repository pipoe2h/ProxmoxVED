...
# upstream   https://github.com/pipoe2h/ProxmoxVED.git (fetch)
# upstream   https://github.com/pipoe2h/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/pipoe2h/ProxmoxVED"
echo ""
