...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/pipoe2h/ProxmoxVED → Fork (top right)
...
git remote add upstream https://github.com/pipoe2h/ProxmoxVED.git
...
- **GitHub**: https://github.com/pipoe2h/ProxmoxVED
- **Issues**: https://github.com/pipoe2h/ProxmoxVED/issues
- **Discussions**: https://github.com/pipoe2h/ProxmoxVED/discussions
