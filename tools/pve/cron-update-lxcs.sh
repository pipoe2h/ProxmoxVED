...
#
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/pipoe2h/ProxmoxVED/main/tools/pve/cron-update-lxcs.sh)"

set -euo pipefail

REPO_URL="https://raw.githubusercontent.com/pipoe2h/ProxmoxVED/main"
